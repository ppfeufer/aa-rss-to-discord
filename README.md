...
```shell
pip install aa-rss-to-discord==3.0.1
```
...
[![Translation status](https://weblate.ppfeufer.de/widget/alliance-auth-apps/aa-rss-to-discord/matrix-auto.svg)](https://weblate.ppfeufer.de/engage/alliance-auth-apps/)
